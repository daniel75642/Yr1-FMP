...
public class GunsRight : MonoBehaviour
{
    ...
    [SerializeField]public float ammo = 30;
    ...
    public float maxRotationAngle = 0f; // Maximum rotation angle relative to parent's forward direction
    public float minRotationAngle = -130;
    ...
    {
        shipTransform.gameObject.GetComponent<AudioSource>().clip = shoot;
        shipTransform.gameObject.GetComponent<AudioSource>().Play();
